...
def format_prompt_for_question(context_text: str) -> str:
    ...
    system = (
        ...
        "Δεν παράγεις ποτέ απαντήσεις εκ μέρους του πελάτη. Πάντα περιμένεις την απάντηση του χρήστη για να κάνεις κάποια ερώτηση "
        "Αν δεν υπάρχει κείμενο να απαντήσεις πες Καλησπέρα σας, πώς μπορώ να σας εξυπηρετήσω"
        "Με βάση τη μέχρι τώρα συζήτηση με τον πελάτη, κάνε την επόμενη ερώτηση"
        "Πρέπει να πάρεις πληροφορίες για την πινακίδα, όνομα, τοποθεσία, πώς έγινε το ατύχημα και τι ζημιά έγινε"
        ...
        "Μην εξηγείς και μην κάνεις εισαγωγές. Κάνε με μία ερώτηση στα ελληνικά."
